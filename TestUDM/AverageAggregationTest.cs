...
namespace TestUDM
{
    ...
    public class AverageAggregationTest
    {
        ...
        public void GetAggregatedValueTest()
        {
            ...
            cell1.SetupGet(foo => foo.Content).Returns((double)0.5);
            cell2.SetupGet(foo => foo.Content).Returns((double)0.5);
            cell3.SetupGet(foo => foo.Content).Returns((double)2);
            List<Cell> cells = new List<Cell>();
            cells.Add(cell1.Object);
            cells.Add(cell2.Object);
            AverageAggregation target = new AverageAggregation();
            double expected = 0.5;
            double actual;
